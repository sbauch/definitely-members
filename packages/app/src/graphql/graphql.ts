...
export type MemberQueryQuery = {
  __typename?: "Query";
  wallet?: {
    __typename?: "Wallet";
    address: any;
    isMember: boolean;
    joinedBlockNumber: any;
    joinedTimestamp: any;
    joinedTxHash: any;
    tokens: Array<{ __typename?: "Token"; id: string }>;
    invited?: Array<{ __typename?: "Wallet"; address: any }> | null;
    invitedBy?: { __typename?: "Wallet"; address: any } | null;
  } | null;
};

export type MembersQueryQueryVariables = Exact<{ [key: string]: never }>;

export type MembersQueryQuery = {
  __typename?: "Query";
  wallets: Array<{
    __typename?: "Wallet";
    address: any;
...
export const MemberQueryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "MemberQuery" },
      variableDefinitions: [
        {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "joinedBlockNumber" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "joinedTimestamp" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "joinedTxHash" },
                },
                {
                  kind: "Field",
...
} as unknown as DocumentNode<MemberQueryQuery, MemberQueryQueryVariables>;
export const MembersQueryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
            ...
            arguments: [
              {
                ...
                value: { kind: "EnumValue", value: "joinedTimestamp" },
              },
              {
                kind: "Argument",
...
} as unknown as DocumentNode<MembersQueryQuery, MembersQueryQueryVariables>;
